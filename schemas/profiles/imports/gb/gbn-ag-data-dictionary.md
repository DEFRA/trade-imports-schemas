...
| `originCountry` | `TradeCountry` | yes | The country the animals or germinals originated from - where they were produced (born, raised, harvested). Required on GBN-AG: a live-animal pre-notification carries a single country of origin for the whole consignment, not per species. For most consignments the country of origin and the country of export coincide; when they differ (animals produced in one country and exported via another), `exportCountry` carries the country of export and this slot carries the country of production. Region of origin lives on `subordinateTradeCountrySubDivision` here: regional disease zoning (FMD-free zones, BTV restriction zones) is a property of where the animal was produced, not where it was exported from. |
