...
| `packageQuantity` | object | no | On GBN-AG, packageQuantity carries the count of boxes, cages, or stalls in which the animals are transported. Optional - bulk consignments where animals are loose-loaded (for example livestock in a single trailer compartment) omit it. |
